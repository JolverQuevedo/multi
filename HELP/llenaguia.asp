    	        ...
    	        <td>
                    <table border="0" align="left" cellpadding="0"cellspacing="0" width="100%">
                        ...
                        <tr valign="bottom" height="8px">
                         ...
                         <tr valign="bottom" height="8px"  id="AL" name = "AL">
                            <td ><input type="text" value="Almacen" id="Text1" readonly tabindex="-1" class="data2" /></td>
                            <td colspan="1"><input type="text" value="00M2" id="alma" class="inputs" maxlength="4"  /></td>
    ...
    <td>
        <table  border="0" cellspacing="1" cellpadding="1" align="left" width="100%">
            ...
            <tr name="lin<%=mm%>" id="lin<%=mm%>">
                ...
                <td><input id="Pos<%=mm%>" name="Pos<%=mm%>" value='..' class="microLeft" readonly tabindex="-1" /></td>
                <td><input id="Col<%=mm%>" name="Col<%=mm%>" value='..' class="microLeft" readonly tabindex="-1" /></td>
                <%lin = lin +1 
                mm = mm + 1%>
...
aCol = new Array()
    for (u = 0; u < fin; u++) {
       ...
       {    aCod[aCod.length++] = trim(eval("document.all.cod" + u + ".value"))
            ...
            aPos[aPos.length++] = trim(eval("document.all.Pos" + u + ".value"))
            aCol[aCol.length++] = trim(eval("document.all.Col" + u + ".value"))
            veri = trim(eval("document.all.cod" + u + ".value"))
            if ((trim(eval("document.all.cod" + u + ".value")) == '.') || veri.length == 10 )
                aDes[aDes.length++] = toAlpha(Left(ltrim(eval("document.all.des" + u + ".value")), 50))
            else
                aDes[aDes.length++] = ''
